...
faculty = Faculty_T(facultyID='4321', fname='Asif', lname='Khaled', department_id='CSE', gender='m')
faculty.save()
...
#     course.save()
course = Course_T('CSE101', program_id='BSc', noOfCredits=3)
course.save()
...
for i in sections:
    section = Section_T(sectionNo=i, course_id='CSE101', faculty_id='4321')
    section.save()
...
for i in datalist:
    ...
    enrollment = Enrollment_T(student_id=i[0], section_id=section_id[0].id, semester='1', year='2019')
    enrollment.save()
...
co = []
co.append(CO_T(coNo=1, course_id='CSE101', plo_id='PLO01'))
co.append(CO_T(coNo=2, course_id='CSE101', plo_id='PLO02'))
co.append(CO_T(coNo=3, course_id='CSE101', plo_id='PLO03'))
co.append(CO_T(coNo=4, course_id='CSE101', plo_id='PLO04'))
