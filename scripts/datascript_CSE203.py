...
courseNameAll = 'CSE203'
semesterNo = '1'
yearNo = '2020'
# Faculty
facultyIDNum = '1237'
faculty = Faculty_T(facultyID=facultyIDNum, fname='Mahbubur', lname='Rahman', department_id='CSE', gender='m')
faculty.save()
...
co = []
co.append(CO_T(coNo=1, course_id=courseNameAll, plo_id='PLO02'))
co.append(CO_T(coNo=2, course_id=courseNameAll, plo_id='PLO03'))
co.append(CO_T(coNo=3, course_id=courseNameAll, plo_id='PLO04'))
co.append(CO_T(coNo=4, course_id=courseNameAll, plo_id='PLO05'))
