...
courseNameAll = 'CSE204'
semesterNo = '2'
yearNo = '2019'
# Faculty
facultyIDNum = '1237'
faculty = Faculty_T(facultyID=facultyIDNum, fname='Raihan', lname='Rafique', department_id='CSE', gender='m')
faculty.save()
...
co = []
co.append(CO_T(coNo=1, course_id=courseNameAll, plo_id='PLO06'))
co.append(CO_T(coNo=2, course_id=courseNameAll, plo_id='PLO07'))
co.append(CO_T(coNo=3, course_id=courseNameAll, plo_id='PLO08'))
co.append(CO_T(coNo=4, course_id=courseNameAll, plo_id='PLO09'))
