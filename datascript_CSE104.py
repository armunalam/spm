...
data = pd.read_csv('SheetCSE101.csv')
...
faculty = Faculty_T(facultyID='1235', fname='Ajmiri', lname='Khan', department_id='CSE', gender='f')
faculty.save()
...
#     course.save()
course = Course_T('CSE104', program_id='BSc', noOfCredits=3)
course.save()
...
for i in sections:
    section = Section_T(sectionNo=i, course_id='CSE104', faculty_id='1235')
    section.save()
...
for i in datalist:
    ...
    enrollment = Enrollment_T(student_id=i[0], section_id=section_id[0].id, semester='3', year='2019')
    enrollment.save()
...
co = []
co.append(CO_T(coNo=1, course_id='CSE104', plo_id='PLO05'))
co.append(CO_T(coNo=2, course_id='CSE104', plo_id='PLO06'))
co.append(CO_T(coNo=3, course_id='CSE104', plo_id='PLO07'))
co.append(CO_T(coNo=4, course_id='CSE104', plo_id='PLO08'))
